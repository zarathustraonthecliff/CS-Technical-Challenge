<section class="py-lg-5 mt-lg-5">
    ...
    <div class=" row card pb-5">
            <div class=" my-5">
                ...
                <h4 class="text-gradient text-primary">Frequently Asked Questions</h4>
                <p>A lot of people don't appreciate the moment until it's past. </p>
                </div>
            </div>
            <div class="">
                ...
                <div class="accordion" id="accordionRental">
                    ...
                    <h5 class="accordion-header" id="headingOne">
                        ...
                        How long does it take to create an Idara account?
                    ...
                    <h5 class="accordion-header" id="headingTwo">
                        ...
                        How can I order a service on Idara ?
                        <i class="collapse-close fa fa-plus text-xs pt-1 position-absolute end-0 me-3" aria-hidden="true"></i>
                        <i class="collapse-open fa fa-minus text-xs pt-1 position-absolute end-0 me-3" aria-hidden="true"></i>
                        </button>
                    </h5>
