...
<?php include("content/navbar.php"); ?>
  ...
  <div class="container">
      <div class="row">
          ...
          <div class="card shadow-xl" style="margin-top:50px; margin-left:50px;" >
            <div class="card-body text-center bg-white border-radius-lg p-3" >
              <a  href="Imprime_demande_B3.pdf">
                <img class="w-100 border-radius-md" src="demande_de_bulletin.jpg" alt="card image">
              </a>
            </div>
          </div>
        </div>
