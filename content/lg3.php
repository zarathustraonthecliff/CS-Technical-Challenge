...
<div class="col-lg-3 mb-lg-0 mb-3 mt-7">
                <ul class="nav flex-column bg-white border-radius-lg p-3 position-sticky top-1">
                <li class="nav-item">
                    <a  class="nav-link text-dark" data-scroll="" href="templates.php">
                        <div class="icon me-2">
                    ...
                    <li class="nav-item">
                    <a  class="nav-link text-dark" data-scroll="" href="creation.php">
                        <div class="icon me-2">
                        <svg class="text-primary" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <li class="nav-item">
                    <a  class="nav-link text-dark" data-scroll="" href="upload.php">
                        <div class="icon me-2">
                    ...
                    <li class="nav-item">
                    <a  class="nav-link text-dark" data-scroll="" href="enattent.php">
                        <div class="icon me-2">
                    ...
                    <li class="nav-item">
                    <a  class="nav-link text-dark" data-scroll="" href="settings.php">
                        <div class="icon me-2">
                        <svg class="text-primary" width="16px" height="16px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <li class="nav-item">
                    <a  class="nav-link text-dark" data-scroll="" href="portfolio.php">
                        <div class="icon me-2">
